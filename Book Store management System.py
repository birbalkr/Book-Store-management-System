...
while True:
    ...
    login_signup = int(input("SIGNUP/LOGIN(1,2): "))
    # SIGNUP
    if login_signup == 1:
                    ...
                    if a == 1:
                        ...
                        if row is not None:
                            ...
                            print("""++++++++++++++++++++++++SUCCESSFULLY ADDED++++++++++++++++++++++++""")
                                ...
                                mycursor.execute("insert into Available_Books(bookname,genre,quantity,author,publication,price) values('" + book + "','" + genre + "','" + quantity + "','" + author + "','" + publication + "','" + str(price) + "')")
                                mydb.commit()
                                print("""
                                    ++++++++++++++++++++++
                                    ++SUCCESSFULLY ADDED++
                                ...
                                if log is not None:
                                    ...
                                    # SEARCH BOOKS ON THE BASIS OF GIVEN OPTIONS
                                        ...
                                        if l == 1:
                                            ...
                                            g = input("Enter Edition to search:")
                                            ...
                                            for y in mycursor:
                                                ...
                                                print("BOOKS OF SUCH Edition ARE NOT AVAILABLE!!!!!!!!!")
                       # BY AUTHOR NAME
                                        elif l == 3:
